...
public class FitsProperties implements Cloneable, Copiable<FitsProperties>, Serializable, TableFormatter.Entries{
    ...
    public void editHeader(Header header) throws HeaderCardException {  
        FitsToolkit.add(header, "OBJECT", getObjectName(), "Observed object's name.");
        FitsToolkit.add(header, "TELESCOP", getTelescopeName(), "Name of telescope.");
        FitsToolkit.add(header, "INSTRUME", getInstrumentName(), "Name of instrument used.");        
        FitsToolkit.add(header, "OBSERVER", getObserverName(), "Name of obserer(s).");
        FitsToolkit.add(header, "DATE-OBS", getObservationDateString(), "Timestamp of observation.");
        FitsToolkit.add(header, "CREATOR", getCreatorName(), getCopyright());
    }
