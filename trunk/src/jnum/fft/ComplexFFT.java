...
public class ComplexFFT extends FFT1D<Complex[]> {
	 ...
	 */
	@Override
	protected void bitReverse(final Complex[] data, final int from, final int to) {
	 ...
	 */
	@Override
	protected void merge2(final Complex[] data, int from, int to, final boolean isForward, int blkbit) {	
	 ...
	 */
	@Override
	protected void merge4(final Complex[] data, int from, int to, final boolean isForward, int blkbit) {	
	 ...
	 */
	private void scale(final Complex[] data, final double value, int threads) {
		if(threads < 2) {
			...
			class Scaler extends Task {		
				...
				public Scaler(final Complex[] data, final int from, final int to, final double value) { 
					super(data, from, to); 
					this.value = value;
				}			
				@Override
				public void process(final Complex[] data, final int from, final int to) {
					for(int i=from; i<to; i++) data[i].scale(value); 
				}
			}
