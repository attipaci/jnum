 ...
 */
public class Unit implements Serializable, Cloneable, Copiable<Unit> {
	...
	/** The Constant SI unit. */
	public final static Unit SI = new Unit("SI", 1.0);
	...
	static {
		register(1.0, "U, uno, count, counts, ct, photon, photons, ph, piece, pcs, unit, adu, bin, SI, 1");
